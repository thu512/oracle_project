	...
	<ul>
		...
		<li><a href="info3.jsp">NETWORK</a></li>
  		...
  		<td width="40%">
	  		...
	  		<a href="#img1">
				<img class="paint" src="img/monitor.jpg">
  		...
  		<td width="40%">
  				<a href="#img2">
					<img class="paint" src="img/ram.jpg">
				</a>

				<!-- lightbox container hidden with CSS -->
				<a href="#_" class="lightbox" id="img2">
				  <img src="img/ram1.jpg">				
				  <img src="img/K-002.jpg">
				  <img src="img/K-003.jpg">
				  <img src="img/K-004.jpg">
				  <img src="img/K-005.jpg">
				</a>
  		</td>
  		...
  		<tr>
  			<td>
  				<a href="#img3">
				<img class="paint" src="img/reboot.jpg">
			</a>
	
			<!-- lightbox container hidden with CSS -->
			<a href="#_" class="lightbox" id="img3">
			  <img src="img/reboot2.jpg">
			  <img src="img/reboot3.jpg">
			  <img src="img/reboot4.jpg">
			  <img src="img/reboot5.jpg">
			</a>
  			</td>
  		<td>
  			<a href="#img4">
				<img class="paint" src="img/speaker.jpg">
			</a>
